...
let price=350;
let newprice=price+(price*0.10)
if (500>pannier>=200){
    console.log("Cout final: "+price+" MAD,Livraison gratuite")


}else if (price>500){
    console.log("Cout final: "+newprice+" MAD,Livraison gratuite")
}else{
    console.log("Cout final: "+price)
}