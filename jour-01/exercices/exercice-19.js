...
let cartValue=150;
let isbanned=false;
function validationaccount(hasAccount,isGuest,isBanned,cartValue){
if((hasAccount===true)||(isGuest===true)&&(cartValue>100)&&(isBanned===false)){
    console.log("commannde valider")
}else {
    console.log("comande non valider")
}
}
validationaccount(hasAccount,isGuest,isBanned,cartValue)
