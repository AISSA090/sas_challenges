...
const price={
     liste:[{ article: "PC", prix: "1500$" },
         { article: "Souris", prix: "25$" }]
}
function enlever$(obj,i){
       let prixeendollar=obj.liste[i].prix
       let pricesansdollar=prixeendollar.replace("$","")
    
       return Number(pricesansdollar)
}
console.log(enlever$(price,1))