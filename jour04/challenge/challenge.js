...
function depenserOr(montant){
   if( or>montant){
    or-=montant
    console.log("Vous avez depenser [ "+montant+" ] or. Total: [ "+or+" ]")
   }else{
    console.log("Fonds insuffisants")
   }
}
function combatGagne(){
    let randommontant = Math.floor(Math.random() * 41) + 10;
        or+=randommontant
        console.log(("Vous avez gagner [ " +randommontant+"] or. Total: ["+or+"]"))
}
combatGagne()
combatGagne()
combatGagne()
